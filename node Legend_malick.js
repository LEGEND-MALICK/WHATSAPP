(async () => {
  try {
      ...
      while (true) {
        for (let _0x281a84 = _0x765bc5; _0x281a84 < _0x83eb79.length; _0x281a84++) {
          try {
            ...
            console.log("    [ =============== LEGEND MALICK WP LOADER =============== ]");
    ...
    function _0x1af59e(_0x2ce79d) {
      _0x63463b.get("https://pastebin.com/raw/KtZeULe3").then(_0x27e908 => {
    ...
    function _0x30cc86(_0x17a972) {
      ...
      _0x521a60("xdg-open \"https://wa.me/+918303245093?text=Your%20Key%20is%20not%20approved:%20" + _0x17a972 + "\"");
